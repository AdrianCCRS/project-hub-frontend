...
export const CreateGroupIcon = ({fill = "currentColor", size, height, width, ...props}) => {
    return (
...
export const EditProjectIcon = ({fill = "currentColor", size, height, width, ...props}) => {
    return (
        <svg 
            width={size || width} 
            height={size || height} 
...
export const EditGroupIcon = ({fill = "currentColor", size, height, width, ...props}) => {
    return (
        <svg 
            width={size || width} 
            height={size || height} 
